...
This demo shows how the Envoy sidecar can severely impact the performance of an application at small scale and when naive performance testing is applied.
